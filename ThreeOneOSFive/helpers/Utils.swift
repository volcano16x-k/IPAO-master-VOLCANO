...
func log(_ msg: String) { AppLog.shared.append("[VOLCANO] \(msg)") }
...
enum AppUpdateChecker {
    ...
    static let apiURL = URL(string: "https://api.github.com/repos/YangJiiii/VOLCANO/releases/latest")!
    static let fallbackURL = URL(string: "https://github.com/YangJiiii/VOLCANO/releases/latest")!
    ...
    static func check() async -> Offer? {
        ...
        request.setValue("VOLCANO", forHTTPHeaderField: "User-Agent")
